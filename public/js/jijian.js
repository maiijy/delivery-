...
$(function () {
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'send_id', title: '编号', width:'4%',align:'center'}
                ...
                ,{field: 'created_time', title: '寄件时间', width:'9%',align:'center'}
                ,{field: 'send_time', title: '寄出时间', width:'9%', sort: true,align:'center'}
    ...
    window.U.ajax('/send/personal',data,'POST',addData);
});
        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'classify', title: '寄件时间', width:'10%',align:'center'}
                    ,{field: 'wealth', title: '寄出时间', width:'10%', sort: true,align:'center'}
                    ,{fixed: 'right', width:'9%',align:'操作人', toolbar: '#barDemo'}
                ]]
            });
